...
func playerHandler(c echo.Context) error {
	...
	query := "SELECT PS.tenant_id, PS.id, PS.player_id, PS.competition_id, PS.score, PS.row_num as row_num, PS.created_at, PS.updated_at FROM player_score as PS INNER JOIN"
